    ...
    <>
      ...
      >
        ...
        <div className="mx-12 p-8 items-center space-y-4">
          <h2 className="font-semibold text-5xl font-mono text-sky-600 ">
            Hi, my name is <br />
            Werner!
          </h2>
          <p className="text-l">
            A passionate developer based in Philippines 📍
          </p>
          <div className="space-y-10">
            ...
            <span className="flex justify-between">
              <img
                title="HTML"
                className="h-16 w-16 transition-transform hover:-translate-y-3"
